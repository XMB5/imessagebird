...
@interface IMMessage : NSObject <NSCopying>
{
    ...
    NSData *_payloadData;
    /**
     Message effect, for example balloons or fireworks
     See list at url below (link may be to old version of iMessageParity)
     https://github.com/LumingYin/iMessageParity/blob/edc85ed237bb3f43c75faa13f46becc14190801e/iMessageParity/iMessageParity.m#L28
     */

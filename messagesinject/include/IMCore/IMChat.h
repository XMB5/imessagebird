...
@property(readonly, nonatomic) NSArray *participants; // @synthesize participants=_participants; //array of Presentity defined in PrivateFrameworks/SocialUI.framework which inherits from IMHandle
...
@property(readonly, nonatomic) NSString *persistentID; //returns chatIdentifier
...
//@property(readonly) NSString *identifier; //use chatIdentifier
